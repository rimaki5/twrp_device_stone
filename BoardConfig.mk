...
OF_CLOCK_POS := 1
FOX_PORTS_TMP := 1
TARGET_DEVICE_ALT := sunstone,moonstone
OF_USE_DMCTL := 1
OF_MAINTAINER := MyTeam
FOX_USE_PATCHELF_BINARY := 1
FOX_USE_FSCK_EROFS_BINARY := 1
FOX_COMPRESS_EXECUTABLES := 1
FOX_MISCELLANEOUS_ROOT_DIRECTORY := /data/media/Fox
FOX_SETTINGS_ROOT_DIRECTORY := /data/media/Fox
OF_NO_ADDITIONAL_MIUI_PROPS_CHECK := 0
FOX_VARIANT := unified
